  ...
  AUTOWARE_MESSAGE_SHARED_PTR(const TrackedObjects) && object_msg1)
{
  ...
  if (node_param_.new_frame_id == msg0.header.frame_id) {
    transformed_objects0 = std::make_shared<TrackedObjects>(msg0);
  } else {
    ...
    transformed_objects0 = getTransformedObjects(
      std::make_shared<const TrackedObjects>(msg0), node_param_.new_frame_id, transform0);
  }

  TrackedObjects::SharedPtr transformed_objects1;
  if (node_param_.new_frame_id == msg1.header.frame_id) {
    transformed_objects1 = std::make_shared<TrackedObjects>(msg1);
  } else {
    ...
    transformed_objects1 = getTransformedObjects(
      std::make_shared<const TrackedObjects>(msg1), node_param_.new_frame_id, transform1);
  }
