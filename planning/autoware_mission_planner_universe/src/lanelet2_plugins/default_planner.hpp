...
/// @tparam NodeT type of the node the planner is initialized with, either rclcpp::Node or
/// autoware::agnocast_wrapper::Node. The publisher and subscription handle types follow NodeT, so
